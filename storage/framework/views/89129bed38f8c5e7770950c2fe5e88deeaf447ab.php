        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('AdminLTE/dist/img/user_default_gray.png')); ?>" class="user-image" alt="User Image">
...
<?php /**PATH /var/www/html/sbr/resources/views/painel/layout/header.blade.php ENDPATH**/ ?>