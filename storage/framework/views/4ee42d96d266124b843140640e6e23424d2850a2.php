...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href=" <?php echo e(route('despesas')); ?> "><i class="ion ion-cash"></i> Home</a></li>
...
<?php /**PATH /var/www/html/adminLTE/resources/views/despesas/layout/app.blade.php ENDPATH**/ ?>