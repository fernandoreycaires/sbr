...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href=" <?php echo e(route('usuarios')); ?> "><i class="fa fa-users"></i> Home</a></li>
...
<?php /**PATH /var/www/html/adminLTE/resources/views/usuarios/layout/app.blade.php ENDPATH**/ ?>