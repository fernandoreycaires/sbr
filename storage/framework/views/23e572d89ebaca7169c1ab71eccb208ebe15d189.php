...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href=" <?php echo e(route('colaboradores')); ?> "><i class="fa fa-users"></i> Home</a></li>
...
<?php /**PATH /var/www/html/adminLTE/resources/views/colaboradores/layout/app.blade.php ENDPATH**/ ?>