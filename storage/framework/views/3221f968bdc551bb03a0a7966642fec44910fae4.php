    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php echo e(asset('AdminLTE/dist/img/user_default_gray.png')); ?>" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class=""><a href="<?php echo e(route('pedidos')); ?>"><i class="fa fa-circle-o"></i> Pedidos </a></li>
                    <li class=""><a href="<?php echo e(route('produtos')); ?>"><i class="fa fa-circle-o"></i> Cadastrar Produtos  </a></li>
                </ul>
            </li>
        </ul>
    </section>
...
<?php /**PATH /var/www/html/sbr/resources/views/painel/layout/menuEsquerdo.blade.php ENDPATH**/ ?>