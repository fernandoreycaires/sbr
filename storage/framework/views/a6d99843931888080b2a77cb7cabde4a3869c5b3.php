...
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href=" <?php echo e(route('fechamentos')); ?> "><i class="ion ion-cash"></i> Home</a></li>
    ...
    <?php if ($__env->exists('fechamentos.js.graficos')) echo $__env->make('fechamentos.js.graficos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


</body>
</html>

<?php /**PATH /var/www/html/adminLTE/resources/views/fechamentos/layout/app.blade.php ENDPATH**/ ?>