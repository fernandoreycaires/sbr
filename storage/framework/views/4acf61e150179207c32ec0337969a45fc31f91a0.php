...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href=" <?php echo e(route('investimentos')); ?> "><i class="ion ion-cash"></i> Home</a></li>
...
<?php /**PATH /var/www/html/adminLTE/resources/views/investimentos/layout/app.blade.php ENDPATH**/ ?>